...
class __xxx__:
	...
	"User-Agent":'user-agent': 'Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0',}
	"Accept": "*/*",
	...
	"Origin": f"https://{cebok}",
	"Content-Type": "application/x-www-form-urlencoded",
	"User-Agent":'user-agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64; rv:41.0) Gecko/20100101 Firefox/41.0',}
	"Accept": "*/*",
	"X-Requested-With": "com.facebook.katana",
	"Sec-Fetch-Site": "same-origin",
	"Sec-Fetch-Mode": "cors",
